...
public class MinValueRuleTests
{
    ...
    {
        MinValueRule<int?> rule = new(null);
    }
    ...
    {
        MinValueRule<string> rule = new("test");
    }
    ...
    {
        // Arrange
        MinValueRule<int> rule = new(1);
        string value = "test";
        // Act
        bool isValid = rule.IsValid(string.Empty, value, out ValidationError? result);
    }
